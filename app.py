...
def renderizar_hero() -> None:
    ...
    st.caption(
        "Produto • Jornada Guiada • Valuation • Tese • Checklist • Painel Executivo • Watchlist • Relatórios • Negócio • Marketing • Conteúdo • Landing Page • Lançamento"
    )
    ...
    with col_home_4:
        st.metric("Execução", "Lançamento Beta")
