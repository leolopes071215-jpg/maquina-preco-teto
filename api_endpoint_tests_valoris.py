...
def _request_json(method: str, path: str, payload: Dict[str, Any] | None = None, timeout: float = 4.0) -> Dict[str, Any]:
...
def executar_suite_endpoint_tests() -> Dict[str, Any]:
    ...
    get_leads = _request_json("GET", "/leads")
    ...
    post_event = _request_json("POST", "/events", event_payload)
    testes.append(
        {
            "teste": "POST /events",
            "ok": post_event["ok"] and post_event["data"].get("ok") is True,
