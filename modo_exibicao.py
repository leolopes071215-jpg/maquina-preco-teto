...
# v2.9 — Modo Usuário Beta / Investidor / Fundador
# ------------------------------------------------------------
...
DESCRICAO_MODOS = {
    MODO_USUARIO_BETA: {
        ...
        "risco_reduzido": (
            ...
            "pré-venda beta, oferta paga, CRM beta, painel beta, Fase 3, dados e UX para usuários comuns."
        ),
    },
    MODO_INVESTIDOR_COMPLETO: {
    ...
    MODO_FUNDADOR: {
        ...
        "descricao": (
            ...
            "CRM beta, painel beta, Fase 3, dados e auditoria UX."
        ),
        ...
        "foco": (
            ...
            "CRM, painel mestre, preparação da Fase 3, dados, UX, backups e monetização."
        ),
        "risco_reduzido": (
            "Nenhum filtro: mostra tudo que existe no MVP, na Fase 2, no painel de decisão "
            "e na preparação do beta pago controlado."
        ),
    },
}
