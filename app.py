...
PAGINAS = {
    ...
    "Central Notificações": (
        "central_notificacoes_valoris",
        "renderizar_central_notificacoes_valoris",
        "Central interna de notificações gerada a partir de agenda, alertas, radar e rotina.",
    ),

    "Higiene Operacional": (
        "higiene_operacional_valoris",
        "renderizar_higiene_operacional_valoris",
        "Saneamento operacional antes de notificações externas.",
    ),

    "Notificações Externas": (
        "notificacoes_externas_valoris",
        "renderizar_notificacoes_externas_valoris",
    ...
    "Exportação Notificações": (
        "exportacao_notificacoes_valoris",
        "renderizar_exportacao_notificacoes_valoris",
    ...
    "Auditoria Comunicações": (
        "auditoria_comunicacoes_valoris",
        "renderizar_auditoria_comunicacoes_valoris",
        "Auditoria completa da trilha de comunicação.",
    ),

    "Resultados Comunicações": (
        "resultados_comunicacoes_valoris",
        "renderizar_resultados_comunicacoes_valoris",
        "Medição de resultados pós-envio manual.",
    ),

    "Otimização Canais": (
        "otimizacao_canais_valoris",
        "renderizar_otimizacao_canais_valoris",
    ...
    "Rascunhos Playbook": (
        "rascunhos_playbook_valoris",
        "renderizar_rascunhos_playbook_valoris",
    ...
    "Cockpit Comunicação": (
        "cockpit_comunicacao_valoris",
        "renderizar_cockpit_comunicacao_valoris",
        "Cockpit executivo da esteira completa de comunicação.",
    ),
    ...
    'Pipeline Principal': ('pipeline_principal_valoris', 'renderizar_pipeline_principal_valoris', 'Pipeline operacional oficial com backend flexível e escrita controlada.'),
    'Radar Principal': ('radar_principal_valoris', 'renderizar_radar_principal_valoris', 'Radar executivo conectado ao Pipeline Principal.'),
    'Pipeline Backend': ('pipeline_backend_flexivel_valoris', 'renderizar_pipeline_backend_flexivel_valoris', 'Pipeline de decisão com leitura flexível e escrita controlada.'),
    'Análise Backend': ('analise_inteligente_backend_valoris', 'renderizar_analise_inteligente_backend_valoris', 'Análise inteligente lendo via backend flexível com ranking executivo.'),
    'Simulador Migração': ('simulador_migracao_banco_valoris', 'renderizar_simulador_migracao_banco_valoris', 'Simula migra??o CSV para SQLite/PostgreSQL antes de criar o banco.'),
    'SQLite Local': ('sqlite_local_valoris', 'renderizar_sqlite_local_valoris', 'Banco SQLite local em modo laboratório.'),
    'Repository Backend': ('repository_backend_sqlite_valoris', 'renderizar_repository_backend_sqlite_valoris', 'Configura CSV ou SQLite como backend flexível do Repository.'),
    'Health Check': ('healthcheck_banco_repository_valoris', 'renderizar_healthcheck_banco_repository_valoris', 'Central de saúde técnica do banco, CSV e Repository.'),
    'Migração Backend': ('migracao_paginas_backend_valoris', 'renderizar_migracao_paginas_backend_valoris', 'Governança de migração gradual das páginas para backend flexível.'),
    'Histórico Backend': ('historico_backend_flexivel_valoris', 'renderizar_historico_backend_flexivel_valoris', 'Histórico de análises lendo via backend flexível com rollback.'),
    'Histórico Análises': ('historico_analises_valoris', 'renderizar_historico_analises_valoris', 'Hist?rico do motor: an?lises salvas, filtros, scores e decis?es.'),
    'Motor + Watchlist': ('integracao_motor_watchlist_valoris', 'renderizar_integracao_motor_watchlist_valoris', 'Ponte entre o motor de análise e a watchlist de acompanhamento.'),
    'Motor + Relatório': ('integracao_motor_relatorio_valoris', 'renderizar_integracao_motor_relatorio_valoris', 'Transforma análise do motor em dossiê premium estruturado.'),
    'Análise Inteligente': ('analise_inteligente_valoris', 'renderizar_analise_inteligente_valoris', 'Central de decisão que une motor, histórico, watchlist e relatório.'),
    'Pipeline Decisão': ('pipeline_decisao_valoris', 'renderizar_pipeline_decisao_valoris', 'Esteira operacional que transforma análise inteligente em próximas ações.'),
    'Radar Revisões': ('radar_revisoes_valoris', 'renderizar_radar_revisoes_valoris', 'Radar de prazos, revisões, alertas e ações pendentes.'),
    'Mapa Dados': ('mapa_dados_contratos_valoris', 'renderizar_mapa_dados_contratos_valoris', 'Mapa de CSVs, contratos, campos e prontidão para banco.'),
    'Repository Único': ('repositorio_unico_valoris', 'renderizar_repositorio_unico_valoris', 'Camada central de dados: CSV hoje, banco amanhã.'),
    'Motor Análise Ativos': ('motor_analise_ativos_valoris', 'renderizar_motor_analise_ativos_valoris', 'Motor central: ativo, dados, preço teto, risco e decisão.'),
    'Recuperação Páginas': ('recuperacao_paginas_valoris', 'renderizar_recuperacao_paginas_valoris', 'Prioriza páginas antigas para recuperação controlada.'),
    'Navegação Segura': ('navegacao_segura_valoris', 'renderizar_navegacao_segura_valoris', 'Catálogo de módulos e recuperação segura de páginas.'),
